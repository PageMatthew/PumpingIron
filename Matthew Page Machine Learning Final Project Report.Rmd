...
```
## Executive Summary
In this paper we explore various methods to predict which form 5 people used in doing barbell curls.  We build a model based on training data that have been split into a training and a validation set then finally use that model to do the prediction.  The final model chosen has an out of sample error rate of 0.8%  
